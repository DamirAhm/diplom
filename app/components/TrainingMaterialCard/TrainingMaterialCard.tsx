...
const TrainingMaterialCard: React.FC<TrainingMaterialCardProps> = ({ material, lang }) => {
  ...
  return (
    <div
      className={`bg-white rounded-lg shadow-md overflow-hidden flex flex-col transition-transform duration-300 hover:-translate-y-2 ${material.image ? "" : "bg-gradient-to-br from-gray-100 to-gray-200"}`}
    >
      {material.image ? (
