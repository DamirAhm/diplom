...
interface SuperpixelControlsProps {
    ...
    setDrawOptions: React.Dispatch<React.SetStateAction<{
        drawCenters: boolean;
        drawBorders: boolean;
        useGradientColors: boolean;
        showGradients: boolean;
...
export const SuperpixelControls: React.FC<SuperpixelControlsProps> = ({
    ...
    const handleParamChange = (name: keyof SuperpixelParams) => (value: number) => {
    ...
    return (
        <div className="w-full p-4 bg-background rounded-lg border border-border">
            <div className="mb-6">
                <div className="flex items-center flex-col gap-3 space-x-2">
                    ...
                    <Button
                        ...
                        className="w-full"
                    >
                        {isProcessing ? dict.common.loading : dict.sandbox.superpixel.processImage}
                    </Button>
                </div>
            </div>
            ...
            <div className="space-y-6">
                <div>
                    <p className="text-sm mb-2 text-muted-foreground flex justify-between">
                        ...
                        <span className="font-medium text-foreground">{params.numberOfSuperpixels}</span>
                    </p>
                    <Slider
                ...
                <div>
                    <p className="text-sm mb-2 text-muted-foreground flex justify-between">
                        ...
                        <span className="font-medium text-foreground">{params.compactnessFactor}</span>
                    </p>
                    <Slider
                ...
                <div>
                    <p className="text-sm mb-2 text-muted-foreground flex justify-between">
                        ...
                        <span className="font-medium text-foreground">{params.elongation.toFixed(1)}</span>
                    </p>
                    <Slider
                ...
                <div>
                    <p className="text-sm mb-2 text-muted-foreground flex justify-between">
                        ...
                        <span className="font-medium text-foreground">{params.iterations}</span>
                    </p>
                    <Slider
                ...
                <div>
                    <p className="text-sm mb-2 text-muted-foreground flex justify-between">
                        ...
                        <span className="font-medium text-foreground">{params.gridSize}</span>
                    </p>
                    <Slider
                ...
                <div>
                    <p className="text-sm mb-2 text-muted-foreground flex justify-between">
                        ...
                        <span className="font-medium text-foreground">{params.adaptiveFactor.toFixed(2)}</span>
                    </p>
                    <Slider
            ...
            {strokeData && (
                <div className="mt-6">
                    <h3 className="text-lg font-medium mb-4 text-foreground">{dict.sandbox.visualization}</h3>
                    <div className="space-y-4">
                        <div className="flex items-center">
                            ...
                            />
                            <label htmlFor="drawCenters" className="text-sm text-foreground">{dict.sandbox.superpixel.showCenters}</label>
                        </div>
                        <div className="flex items-center">
                            <input
                                type="checkbox"
                                ...
                                className="mr-2 h-4 w-4 rounded border-gray-300 text-primary focus:ring-primary"
                            />
                            <label htmlFor="drawBorders" className="text-sm text-foreground">{dict.sandbox.superpixel.showBorders}</label>
                        </div>
                        <div className="flex items-center">
                            <input
                                type="checkbox"
                                ...
                                className="mr-2 h-4 w-4 rounded border-gray-300 text-primary focus:ring-primary"
                            />
                            <label htmlFor="useGradientColors" className="text-sm text-foreground">{dict.sandbox.superpixel.showColorGradient}</label>
                        </div>
                        <div className="flex items-center">
                            <input
                                type="checkbox"
                                ...
                                className="mr-2 h-4 w-4 rounded border-gray-300 text-primary focus:ring-primary"
                            />
                            <label htmlFor="showGradients" className="text-sm text-foreground">{dict.sandbox.superpixel.showGradients}</label>
                        </div>
                        <div className="flex items-center">
                            <input
                                type="checkbox"
